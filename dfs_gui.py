...
def addnode(event):
    ...
    wd=c.create_oval(event.x-20,event.y-20,event.x +20, event.y+20, fill='PaleVioletRed1', outline='PaleVioletRed1')
...
btn=tk.Button(root,text = 'GO',font="helvetica 20", bg='PaleVioletRed1' ,command=lambda: dfs(source.get(),visited))
